...
primitives = [
        ...
        p['rotate_ccw'],
        # p['rotation_invariant'], p['color_invariant'], p['size_invariant']
        # p['color_transform'],
        ...
        # p['area'],
        # p['color'], 
        # p['construct_mapping'], p['construct_mapping2'], p['construct_mapping3'], p['construct_mapping4'],
        # p['place_into_grid'], p['place_into_input_grid'],
        # p['rows'], p['columns'],
        # p['vstack'], p['hstack'],
        ]
