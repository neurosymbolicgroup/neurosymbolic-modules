...
for f in benchFiles:
    with open(myDir + f, 'r') as fdes:
        ...
        out = 'output/morpheus-11-10/' + compLen + '/r' + idx + '.txt'
        cmd = 'gtimeout 300 ant neoMorpheus -Dapp=./problem/Morpheus-PLDI/r'+idx+'.json -Ddepth='+ compLen +' -Dlearn=false -Dstat=false -Dfile=' + loc + ' > '  +  out
        print cmd
        os.system(cmd)
